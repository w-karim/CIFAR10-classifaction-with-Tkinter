...
refresh_img = PhotoImage(file = "./img_refresh.png")
exit_img = PhotoImage(file = "./img_exit.png")
select_img = PhotoImage(file = "./img_select.png")
classify_img = PhotoImage(file = "./img_classify.png")


model = models.load_model("cifar_image_classification.model")
